<?php
    ...
    // Check file size
    if ($_FILES[INPUT_NAME]["size"] > FILE_MAX_SIZE) {
      echo "Sorry, your file is too large.";
      $uploadOk = false;
    }
    
    // Allow certain file formats
    if( ! in_array($imageFileType, ALLOVED_FILE_TYPES) ) {
      echo "Sorry, only ".strtoupper(implode(",", ALLOVED_FILE_TYPES))." files are allowed.";
      $uploadOk = false;
    }
